...
import { FaEdit, FaTrash, FaSearch, FaPlus, FaMoneyBillWave, FaTimesCircle, FaSave, FaExclamationTriangle } from 'react-icons/fa';
                                ...
                                <tbody>
                                    {filteredLoans.map((loan) => (
                                        ...
                                        >
                                            ...
                                            <td>
                                                <div className="font-medium">৳{loan.maxLoanLimit?.toLocaleString()}</div>
                                            </td>
                        ...
                        {filteredLoans.map((loan) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between py-3 border-t border-b border-base-100 mb-4">
                                    <div className="text-sm text-base-content/60">Max Limit:</div>
                                    <div className="font-bold">৳{loan.maxLoanLimit?.toLocaleString()}</div>
                                </div>
