            ...
            <Container className="relative z-10">
                <Reveal>
                    <div className="text-center mb-0">
                        <SectionTitle
                            heading={<>What Our <span className="bg-linear-to-r from-[#B91116] to-[#ff4d4d] bg-clip-text text-transparent">Clients Say</span></>}
                            subHeading="Testimonials"
                        />
                        <p className="text-lg text-base-content/60 max-w-2xl mx-auto -mt-10 mb-10">
